      ...
      <h2 className="text-2xl font-semibold text-text-primary mt-12 mb-6">
        ...
        <div className="grid grid-cols-3 gap-4 max-w-lg">
          <a
            ...
            className="p-4 bg-surface rounded-lg hover:border-accent border border-surface transition-all flex flex-col items-center gap-2 group"
          >
            <svg className="w-8 h-8 text-text-secondary group-hover:text-accent transition-colors group-hover:scale-110 transform" viewBox="0 0 448 512" fill="currentColor">
          ...
          <a
            ...
            className="p-4 bg-surface rounded-lg hover:border-accent border border-surface transition-all flex flex-col items-center gap-2 group"
          >
            <svg className="w-8 h-8 text-text-secondary group-hover:text-accent transition-colors group-hover:scale-110 transform" viewBox="0 0 500 500" fill="currentColor">
          ...
          <a
            ...
            className="p-4 bg-surface rounded-lg hover:border-accent border border-surface transition-all flex flex-col items-center gap-2 group"
          >
            <svg className="w-8 h-8 text-text-secondary group-hover:text-accent transition-colors group-hover:scale-110 transform" viewBox="0 0 24 24" fill="currentColor">
