    ...
    <div className="max-w-5xl mx-auto px-6 py-20">
      ...
      <section className="mb-32">
        ...
        <p className="text-2xl text-text-secondary mb-8 leading-relaxed">
          a data scientist at the intersection of<br />
      ...
      <section>
        ...
        <div className="mt-12 text-center">
          <Link
            href="/projects"
            className="inline-block px-6 py-3 bg-surface hover:bg-accent hover:text-background transition-colors rounded-md"
          >
            View All Projects →
          </Link>
        </div>
